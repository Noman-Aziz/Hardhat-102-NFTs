...
/**
 * @dev When we mint an NFT, we will trigger a Chainlink VRF call to get us random number
 * Using that number, we will get a Random NFT
 * 1. Pug : Super Rare [0 - 10]
 * 2. Shiba : Medium Rare [10 - 30]
 * 3. St. Bernard : Common [30 - MAX_CHANCE_VALUE]
